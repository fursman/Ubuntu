...
# ============================================================================
# 🖥️  Ubuntu → Hyprland Setup Script
...
step "2/10 · Installing NVIDIA driver 590 (open)"
if nvidia-smi &>/dev/null; then
    warn "NVIDIA driver already installed, skipping"
else
...
step "Bonus · Setting up wallpaper"
mkdir -p "$HOME/Pictures/Wallpapers"
if [ ! -f "$HOME/Pictures/Wallpapers/current.jpg" ]; then
    curl -fsSL "https://raw.githubusercontent.com/dracula/wallpaper/main/first-collection/dracula.png" \
        -o "$HOME/Pictures/Wallpapers/current.jpg" 2>/dev/null || \
        warn "Could not download wallpaper — place your own at ~/Pictures/Wallpapers/current.jpg"
fi
success "Wallpaper ready"

# ── wlogout icons reminder ──
echo ""
warn "wlogout icons not included — place PNG icons (1.png through 6.png) in ~/.config/wlogout/icons/"
warn "  1=lock  2=logout  3=suspend  4=hibernate  5=shutdown  6=reboot"
